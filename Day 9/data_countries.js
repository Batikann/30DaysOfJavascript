...
/*
  ...
  getFirstTenCountries(dataCountries)
*/
...
getLastTenCountries(dataCountries);

//console.log(dataCountries.length-10);
*/

//Step-7
/*
let wordsLenght = [];
let words=['A','B','C','D','E','F','G','H','I','J','K','L','M','N','O','P','R','S','T','U','V','W','X','Y','Z'];
let values = dataCountries.map((word) => word.name.slice(0, 1));
for (let i = 0; i < values.length; i++) {
 for (let x = 0; x < values.length; x++) {
    if (values[x] == values[i]) {
      console.log(values.lastIndexOf(values[i])-values.indexOf(values[x]));
    }
...
//Step-1-1
//let values=dataCountries.sort();

//Step-1-2
//let values=dataCountries.sort((a,b) => (a.capital > b.capital) ? 1 : ((b.capital > a.capital) ? -1 : 0));

//Step-1-3
/*
let values=dataCountries.sort((a,b) => (a.population > b.population) ? -1 : ((b.population > a.population) ? 1 : 0));
console.log(values);
*/
...
//Step-3
/*
const mostPopulatedCountries=(Array,repeatValue)=>{
  let value =Array.sort((a,b) => (a.population > b.population) ? -1 : ((b.population > a.population) ? 1 : 0)).slice(0,repeatValue);
  let reuslt=value.map(({name, population}) => ({name, population}));
  console.log(reuslt);
}
mostPopulatedCountries(dataCountries,10);
*/
...
function statistics() {
  ...
  this.uniqueArr = function () {
    ages.sort(function (a, b) {
      return a - b;
    });
    for (i = ages.length - 1; i > 0; i--) {
      if (i <= ages.length && ages[i] === ages[i - 1]) {
        ages.splice(i, 1);
      }
    }
    return ages;
  ...
  this.range = function () {
    let val = statistics.max() - statistics.min();
    return val;
  };
  ...
  this.median = function () {
    // dizinin ortanca elemanını bulan fonksiyon
    ages.sort(function (a, b) {
      return a - b;
    });
    let val = ages[(ages.length - 1) / 2];
    return val;
  };
