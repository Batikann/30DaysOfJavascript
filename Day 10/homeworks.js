...
//Step-1
/*
let val=dataCountries.map(x=>x.languages);
let newArr=[];
...
console.log(`Object file includes ${[...uniqNewArr].sort().length} different languages`);
*/

//Step-2
const mostSpokenLanguages = (countries, repeatValue) => {
...
console.log(mostSpokenLanguages(dataCountries,10));
